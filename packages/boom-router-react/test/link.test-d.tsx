...
import { Link, LinkProps, type Path } from "boom-router";
...
describe("<Link /> types", () => {
  ...
  it("should work with generic type", () => {
    <Link<NetworkLocationHook> href="/" host="boom-router.com">
      test
    </Link>;
    ...
    <Link<NetworkLocationHook> href="/" host="boom-router.com" retries={4}>
      test
    </Link>;
  });
});
...
describe("<Link /> with `asChild` prop", () => {
  ...
  it("should work with generic type", () => {
    <Link<NetworkLocationHook> asChild to="/" host="boom-router.com">
      <div>test</div>
    </Link>;
    ...
    <Link<NetworkLocationHook>
      asChild
      to="/"
      host="boom-router.com"
      retries={4}
    >
      <div>test</div>
    </Link>;
