...
import { useRoute, Match, Router, RegexRouteParams } from "boom-router";
...
it("is case insensitive", () => {
  ...
  assertRoute("/Users/:Name", "/users/rohit", { 0: "rohit", Name: "rohit" });
});
...
it("supports other characters in segments", () => {
  assertRoute("/users/:name", "/users/1-rohit", {
    0: "1-rohit",
    name: "1-rohit",
  });
